<div class="container">
    <?php if (!isset($_GET['signup']) && !isset($_GET['edit'])) { ?>
        <form method="post" onsubmit="return false" id="login-form">
            <div class="form-group">
                <label for="email">Email address</label>
                <input type="email" name="login_email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Enter email">
